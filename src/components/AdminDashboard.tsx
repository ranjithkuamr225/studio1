...
import { Upload, Plus, Image as ImageIcon, MessageSquare } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const handleUpload = () => {
    console.log('Uploading images:', uploads);
              ...
              {uploads.length > 0 && (
                <div className="mt-8">
                  ...
                  <motion.button
                    ...
                    className="mt-6 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600"
                  >
